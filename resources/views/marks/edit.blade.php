    ...
    <div class="card">
        <div class="card-body p-0">
            ...
            <div class="table-responsive">
                <form method="POST" id="myForm" action="{{route('studentMarks_update')}}">
                    @csrf
                    ...
                    <div class="card-body d-none" id="marks_entry">
                        ...
                        <button type="submit" class="btn btn-success" style="margin-top: 32px;">Update Marks &nbsp;&nbsp; <i class="fas fa-save"></i></button>
                    </div>
                </form>
            </div>
...
<script type="text/javascript">
    $(document).on('click', '#search', function() {
        ...
        $.ajax({
            url: "{{route('studentMarksTable_filter')}}",
            type: 'GET',
            data: {
                'session_id': session_id,
                'class_id': class_id,
                'subject_assigning_id': subject_assigning_id,
            ...
            success: function(data) {
                ...
                $.each(data, function(key, value) {
                    html +=
                        ...
                        '<td>' + value.roll_no + '</td>' +
                        '<td><input type="text" name="marks[]" value="' + value.marks + '" class="form-control"></td>' +
                        '</tr>'
                })
