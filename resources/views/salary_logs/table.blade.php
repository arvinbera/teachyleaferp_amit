        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="120">
                    ...
                    <div class='btn-group'>
                        <a href="{{ route('salary_log', [$employeeRegistrations->id]) }}" class='btn btn-default btn-xs'>
                            <i class="far fa-eye"></i>
                        </a>
                        <a href="{{ route('salary_increment', [$employeeRegistrations->id]) }}" class='btn btn-default btn-xs'>
