...
class EmployeeRegistrationsFactory extends Factory
{
    /**
     ...
     * @var string
     */
    protected $model = EmployeeRegistrations::class;
    ...
    public function definition()
    {
        ...
        'address_current' => $this->faker->text,
        'address_permanent' => $this->faker->text,
